...
# Average CV score on the training set was: 0.8773037365889753
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=SGDClassifier(alpha=0.0, eta0=0.1, fit_intercept=True, l1_ratio=0.75, learning_rate="invscaling", loss="log", penalty="elasticnet", power_t=0.5)),
