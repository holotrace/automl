...
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=ExtraTreesClassifier(bootstrap=True, criterion="entropy", max_features=0.9000000000000001, min_samples_leaf=3, min_samples_split=15, n_estimators=100)),
    DecisionTreeClassifier(criterion="gini", max_depth=8, min_samples_leaf=3, min_samples_split=11)
)
