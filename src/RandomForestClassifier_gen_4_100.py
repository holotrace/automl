...
# Average CV score on the training set was: 0.8639105520614955
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=LGBMClassifier(boosting_type="dart", colsample_bytree=0.7, learning_rate=0.05, min_child_samples=500, n_estimators=20, n_jobs=1, num_leaves=250, subsample=0.9)),
