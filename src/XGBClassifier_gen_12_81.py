...
exported_pipeline = make_pipeline(
    RFE(estimator=ExtraTreesClassifier(criterion="entropy", max_features=0.45, n_estimators=100), n_features_to_select=0.8999999999999999, step=0.9000000000000001),
    RobustScaler(),
    XGBClassifier(learning_rate=0.1, max_depth=7, min_child_weight=12, n_estimators=100, nthread=1, subsample=0.8500000000000001)
)
