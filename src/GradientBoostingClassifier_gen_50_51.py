...
# Average CV score on the training set was: 0.8898229020894659
exported_pipeline = make_pipeline(
    ...
    GradientBoostingClassifier(learning_rate=0.01, max_depth=3, max_features=0.2, min_samples_leaf=2, min_samples_split=15, n_estimators=100, subsample=0.3)
)
