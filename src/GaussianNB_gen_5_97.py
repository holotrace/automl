...
# Average CV score on the training set was: 0.8651146589259795
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=ExtraTreesClassifier(bootstrap=True, criterion="entropy", max_features=0.7500000000000001, min_samples_leaf=5, min_samples_split=17, n_estimators=100)),
    RobustScaler(),
    GaussianNB()
)
