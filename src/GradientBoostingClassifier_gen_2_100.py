...
exported_pipeline = make_pipeline(
    ...
    GradientBoostingClassifier(learning_rate=0.5, max_depth=4, max_features=0.8500000000000001, min_samples_leaf=4, min_samples_split=15, n_estimators=100, subsample=0.5)
)
