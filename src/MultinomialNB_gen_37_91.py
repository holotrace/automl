...
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=GradientBoostingClassifier(learning_rate=0.5, max_depth=4, max_features=0.9500000000000001, min_samples_leaf=10, min_samples_split=6, n_estimators=100, subsample=0.15000000000000002)),
    Normalizer(norm="l2"),
