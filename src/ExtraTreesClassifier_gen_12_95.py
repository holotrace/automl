...
# Average CV score on the training set was: 0.87585081802945
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=ExtraTreesClassifier(bootstrap=False, criterion="entropy", max_features=0.6000000000000001, min_samples_leaf=15, min_samples_split=9, n_estimators=100)),
    SelectPercentile(score_func=f_classif, percentile=77),
    ExtraTreesClassifier(bootstrap=False, criterion="gini", max_features=0.6500000000000001, min_samples_leaf=8, min_samples_split=20, n_estimators=100)
)
