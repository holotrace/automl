...
# Average CV score on the training set was: 0.8768889268334329
exported_pipeline = make_pipeline(
    StackingEstimator(estimator=SGDClassifier(alpha=0.01, eta0=0.1, fit_intercept=True, l1_ratio=0.25, learning_rate="invscaling", loss="perceptron", penalty="elasticnet", power_t=50.0)),
    StackingEstimator(estimator=AdaBoostClassifier(algorithm="SAMME", learning_rate=0.1, n_estimators=100)),
    GaussianNB()
)
