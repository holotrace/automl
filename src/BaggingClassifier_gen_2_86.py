...
exported_pipeline = make_pipeline(
    MinMaxScaler(),
    StackingEstimator(estimator=ExtraTreesClassifier(bootstrap=False, criterion="gini", max_features=0.4, min_samples_leaf=19, min_samples_split=7, n_estimators=100)),
    BaggingClassifier(bootstrap=True, bootstrap_features=True, max_features=0.7, max_samples=0.7999999999999999, n_estimators=10)
)
