...
exported_pipeline = make_pipeline(
    ...
    StackingEstimator(estimator=LGBMClassifier(boosting_type="dart", colsample_bytree=1.0, learning_rate=0.1, min_child_samples=100, n_estimators=350, n_jobs=1, num_leaves=80, subsample=0.9)),
