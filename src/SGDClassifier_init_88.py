...
exported_pipeline = SGDClassifier(alpha=0.0, eta0=0.01, fit_intercept=False, l1_ratio=0.5, learning_rate="constant", loss="squared_hinge", penalty="elasticnet", power_t=0.1)
