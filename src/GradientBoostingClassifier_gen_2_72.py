...
exported_pipeline = GradientBoostingClassifier(learning_rate=0.01, max_depth=5, max_features=0.9000000000000001, min_samples_leaf=12, min_samples_split=11, n_estimators=100, subsample=0.5)
