...
exported_pipeline = LGBMClassifier(boosting_type="dart", colsample_bytree=0.9, learning_rate=0.01, min_child_samples=7, n_estimators=35, n_jobs=1, num_leaves=35, subsample=0.9)
